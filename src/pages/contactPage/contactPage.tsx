  ...
  return (
    <section className="contact-page">
      ...
      <section className="contact-info">
        ...
        <form className="col contact-form">
          <div className="c-form">
            <label htmlFor="name" className="form-label">Your name</label>
            <input type="text" id="name" className="form-input" placeholder="Abc" />

            <label htmlFor="email" className="form-label">Email address</label>
            <input type="email" id="email" className="form-input" placeholder="Abc@def.com" />

            <label htmlFor="subject" className="form-label">Subject</label>
            <input type="text" id="subject" className="form-input" placeholder="This is optional" />

            <label htmlFor="message" className="form-label">Message</label>
            <textarea id="message" className="form-textarea" placeholder="Hi! I'd like to ask about"></textarea>
